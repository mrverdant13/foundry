...
///
/// Groups subcommands that author, inspect, derive, sync, and import molds. See
...
/// [MoldSyncCommand] for `foundry mold sync`, and [MoldImportCommand] for
/// `foundry mold import`.
/// {@endtemplate}
class MoldCommand extends Command<int> {
  ...
  MoldCommand({required Logger logger}) {
    ...
    addSubcommand(MoldSyncCommand(logger: logger));
  ...
  @override
  String get description => 'Author, inspect, derive, sync, and import molds.';
}
