...
/// Drops configured line ranges from [content] when [relativePosixPath]
/// matches.
///
...
/// [PatternLineDeletion.filePath] values are compared with POSIX path
/// equality.
///
/// Ranges use zero-based, inclusive line indices ([PatternLineRange]).
/// Entries whose [PatternLineDeletion.filePath] does not match
